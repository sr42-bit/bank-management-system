...
public class DashboardService {
    ...
    // 🔥 ================= CRITICAL FIX =================
    // Get accounts for logged-in user (JWT-based filtering)
    public List<AccountJpaEntity> getAccountsByCustomerId(String customerId) {
        ...
        if (accounts == null || accounts.isEmpty()) {
            System.out.println("No accounts found for customerId: " + customerId);
        }
